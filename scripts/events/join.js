...
.then(response => {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    return api.sendMessage("চলে এসেছি আমি পিচ্চি সাকিন তোমাদের মাঝে🤭!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
সা্ঁকি্ঁন্ঁ⎯͢⎯⃝🪽BOT CONNECTED SUCCESFUL !!! 
...
DEVELOPER : সা্ঁকি্ঁন্ঁ⎯͢⎯⃝🪽 

🟣Facebook Account Link: 

https://www.facebook.com/xs.xakin
